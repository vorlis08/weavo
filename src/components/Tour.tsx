...
const STEPS: Step[] = [
  {
    ...
    body: 'Press C or click here to jot down an event, a task, or a stray thought. Weavo reads the date, #project and @person straight out of the sentence.',
  },
  {
    ...
    place: 'right',
    title: 'Find and jump',
    body: '⌘K / Ctrl-K opens a search across every record — and lets you jump to any view.',
  },
  {
    sel: '[data-tour="views"]',
    route: '/',
    place: 'right',
    title: 'One set of records, six views',
    body: 'Calendar, board, timeline, a graph of your notes, and a written digest — the same items, seen from different angles.',
  },
  {
    ...
    body: 'File anything under a project. Click one to open its page and its own board.',
  },
  {
    sel: '[data-tour="board-col"]',
    route: '/board',
    place: 'bottom',
    title: 'Drag things along',
    body: 'On the board, drag a card between columns to change its status. Add one inline with the + on a column header.',
  },
  {
    ...
    place: 'right',
    title: 'Settings',
    body: 'Connect Google, set your working hours, turn on notifications, export your data.',
  },
  {
    sel: '',
    route: '/guide',
    ...
    body: 'The full written guide is right here whenever you want it.',
  },
]
  ...
  return (
    <div className="fixed inset-0 z-[70]">
      ...
      >
        ...
        <p className="mt-1.5 text-[12.75px] leading-relaxed text-ink-2">{s.body}</p>
